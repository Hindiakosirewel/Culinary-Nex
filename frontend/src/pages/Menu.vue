<template>
    <div class="menu-section">
        <div class="heading">
            <span>menu</span>
            <h3>Order Delicious Meals!</h3>
        </div>

        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                <div class="row search-box">
                    <input type="text" class="search-input" v-model="foodObj.name" placeholder="Search Food" />
                </div>
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rType" id="mType" value="regular meal" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="mType" class="d-flex justify-content-between">regular meal<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>

                        <li>
                            <input type="button" name="rType" id="vType" value="student meal" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="vType" class="d-flex justify-content-between">student meal<button class="unselect-btn"
                                    @click="unselectTypeBtn($event)">X</button></label>
                        </li>
                ...
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="tacoFilterFoodBtn" name="tacoFilterFoodBtn" class="menu-tab-item"
                            value="dish" @click="filterFoodBtn($event)" />
                        ...
                        <input type="button" id="drinkFilterFoodBtn" name="drinkFilterFoodBtn" class="menu-tab-item"
                            value="fruit" @click="filterFoodBtn($event)" />
                    </div>
                </div>
