        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="coAddress" id="coAddress" placeholder="Enter your name"
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="radio" name="payment" value="card" id="paymentCard"
                                v-model="checkoutObj.paymentMethod" /><span>GCash Payment</span>
                        </div>
                    ...
                    <div v-if="checkoutObj.paymentMethod == 'card'">
                        ...
                        <div class="form-group">
                            <input v-upcase type="text" name="coCardName" placeholder="Enter the name in your gcash account "
