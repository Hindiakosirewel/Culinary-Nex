<template>
    <div class="header">
        ...
        <img src="https://drive.google.com/uc?id=1ljugUb3VcMWk1s0T03C5UCuzALwvxF-2" alt="CulinaryNex Logo" />
        CulinaryNex
    </router-link>
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/table">location</router-link>
        </nav>
